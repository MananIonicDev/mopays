...
@Component({
  selector: 'app-jobs-comment',
  templateUrl: './jobs-comment.page.html',
  styleUrls: ['./jobs-comment.page.scss'],
})
export class JobsCommentPage implements OnInit {
  ...
  sendComment() {
    ...
    firebase.database().ref('/jobs/' + this.id).child('comment').push({
