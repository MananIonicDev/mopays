...
@Component({
  selector: 'app-imagemodalbizpro',
  templateUrl: './imagemodalbizpro.page.html',
  styleUrls: ['./imagemodalbizpro.page.scss'],
})
export class ImagemodalbizproPage implements OnInit {
