...
@Component({
  ...
  templateUrl: './feed-edit.page.html',
  styleUrls: ['./feed-edit.page.scss'],
})
export class FeedEditPage implements OnInit {
 ...
 async addFeedTextOnly(){
  ...
  await this.loading.present();
    ...
    firebase.database().ref('feeds').child(this.id).update({
